...
void print_basic_screen()
{
    ...
    print_char('-',79,1,LIGHTCYAN);
    print_char('-',79,3,LIGHTCYAN);
    print_title("Enter \"0\" to cancel input",55,4,LIGHTGREEN);
    print_char('-',79,6,YELLOW);
    print_char('-',79,22,YELLOW);
}
void add_questions()
{
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Questions.bin","rb");
    if(fp==NULL)
    {
        fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Questions.bin","wb");
        if(fp==NULL)
        {
...
{
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","rb");
    if(fp==NULL)
    {
        fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","wb");;
        if(fp==NULL)
        {
            print_char(' ',79,25,BLACK);
        ...
        user usr={"master_admin","Himanshu","rakesh","master_admin"," "," ","7089210355"};
...
{
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Users.bin\n",1,25,RED);
...
void add_theater()
{
    ...
    clrscr();
    print_basic_screen();
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file users.bin\n",1,25,RED);
...
void show_theater()
{
    clrscr();
    print_basic_screen();
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file users.bin\n",1,25,RED);
...
{
    FILE *fp1=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin","rb");
    if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    FILE *fp2=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempBookings.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    fclose(fp2);
    int x,y;
    x=remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin");
    if(x==0)
    {
        y=rename("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempBookings.bin","C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin");
        if(y==0)
            return 1;
    }
    return 0;
...
{
    FILE *fp1=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin","rb");
    if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    FILE *fp2=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempMovie.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    while(fread(&mov,sizeof(mov),1,fp1)==1)
    {
        ...
        else
        {
            ...
            if(resp==0)
            {
                fclose(fp1);
                fclose(fp2);
                remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempMovie.bin");
                getch();
                return 0;
            }
        }
    ...
    fclose(fp2);
    int x,y;
    x=remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin");
    if(x==0)
    {
        y=rename("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempMovie.bin","C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin");
        if(y==0)
        {
            return 1;
        }
...
int  delete_theater()
{
   ...
   FILE *fp1=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin","rb");
   if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Theaters.bin\n",1,25,RED);
   ...
   FILE *fp2=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempTheaters.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
         ...
         else
         {
             if(th.is_booked==1)
             {
                 ...
                 if(resp==0)
                 {
                    fclose(fp1);
                    fclose(fp2);
                    remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempTheaters.bin");
                    return 0;
                 }
             }
         }
    ...
    fclose(fp2);
    int x,y;
    x=remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin");
    if(x==0)
    {
        y=rename("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempTheaters.bin","C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin");
        if(y==0)
            return 1;
    }
    return 0;
...
void add_movie()
{
    ...
    clrscr();print_basic_screen();
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Movie.bin\n",1,25,RED);
...
char * get_movie_name(char *mv_id)
{
    movie mv;
    static char temp[100];
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Movie.bin\n",1,25,RED);
    ...
    {
        if(strcmp(mv.movie_id,mv_id)==0)
        {
            strcpy(temp,mv.movie_name);
            fclose(fp);
            return temp;
        }
    }
...
void show_movie()
{
    ...
    print_title("FIRST-B",39,row,LIGHTBLUE);
    print_title("SECOND-B",52,row,LIGHTBLUE);
    print_title("THIRD-B",68,row,LIGHTBLUE);
    movie mov;
    row+=2;
    char prv_mov[100]={" "};
    char temp[100];
    while(fread(&mov,sizeof(mov),1,fp)==1)
    {
        if(strcmp(prv_mov,mov.movie_name)!=0)
        {
            ...
            print_title(temp,39,row,YELLOW);

            sprintf(temp,"%d",mov.second_block_price);
            print_title(temp,52,row,YELLOW);

            sprintf(temp,"%d",mov.third_block_price);
            print_title(temp,68,row,YELLOW);
...
int * get_seat_numbers(movie * m)
{
    ...
    FILE * fp = fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\SeatNumbers.bin", "wb+");
    if(fp == NULL)
    {
        print_char(' ', 79, 25, BLACK);
    ...
    do
    {
        ...
        do
        {
            ...
            if(seat_number==0)
            {
                ...
                fclose(fp);
                getch();
                if(remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\SeatNumbers.bin"))
                {
                    print_char(' ', 79, 25, BLACK);
    ...
    if(p==NULL)
    {
        ...
        getch();
        fclose(fp);
        remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\SeatNumbers.bin");
        return NULL;
    }
    rewind(fp);
...
void booking(user * u)
{
    ...
    FILE * fp = fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin", "ab+");
    if(fp == NULL)
    {
        print_char(' ', 79, 25, BLACK);
...
{
    print_basic_screen();
    FILE *fp=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Bookings.bin\n",1,25,RED);
    ...
    if(ftell(fp)==0)
    {
        ...
        return;
            ...
            print_title("Theater ",15,row,LIGHTBLUE);
            print_title("Movie ",33,row,LIGHTBLUE);
            print_title("Seat No",45,row,LIGHTBLUE);
            print_title("Show Date",55,row,LIGHTBLUE);
            row+=2;
            while(fread(&tk,sizeof(tk),1,fp)==1)
            {
                ...
                print_title(get_teaterid(tk.theater_id),15,row,YELLOW);
                print_title(get_movie_name(tk.movie_id),33,row,YELLOW);

                sprintf(temp_str,"%d",tk.seat_number);
                print_title(temp_str,45,row,YELLOW);

                sprintf(temp_str,"%02d/%02d/%04d",tk.show_date.tm_mday,tk.show_date.tm_mon,tk.show_date.tm_year);
                print_title(temp_str,55,row,YELLOW);
                row++;
                }
            }
fclose(fp);
...
int delete_my_Account(user *u)
{
   ...
   // print_title_in_middle("Are you sure to the contact details(Y/y/N/n):",10,YELLOW);
    fflush(stdin);
    scanf("%c",&choice);
    if(choice=='n'|| choice=='N')
    {
    ...
    {
            FILE *fp1=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","rb");
            if(fp1==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file users.bin\n",1,25,RED);
            ...
            FILE *fp2=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Tempusers.bin","wb");
            if(fp2==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file tempuser.bin\n",1,25,RED);
                perror("Reason:");
                getch();
                return 1;
            }
            //bookinng
            FILE *fp3=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin","rb");
            if(fp3==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            FILE *fp4=fopen("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempBookings.bin","wb");
            if(fp4==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file tempBookings.bin\n",1,25,RED);
            ...
            if(x==0)
            {
                ...
                if(y==0)
                {
                    x=remove("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin");
                    if(x==0)
                        {
                            y=rename("C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Tempusers.bin","C:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin");
                            if(y==0)
                            {
                                print_char(' ',79,25,0);
